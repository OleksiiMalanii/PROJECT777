<template>
  <section class="flex h-screen bg-linear-to-t from-gray-900 to-indigo-950 text-white font-sci-fi">
    <!-- Decorations -->
    <img
    ...
    <!-- Soldier Image -->
    <div class="hidden md:flex w-2/3 z-10 items-end justify-center">
      <img src="/src/assets/Soldier.png" draggable="false" alt="Soldier" class="h-[90vh] object-contain unselectable" />
    </div>
    ...
    <span class="material-symbols-outlined text-xl">
      ...
      <p class="mt-4 text-sm">
        ...
        <router-link to="/register" class="text-orange-500 hover:underline">Register!</router-link>
      </p>
    </div>
  </section>
</template>
...
const submit = async () => {
  ...
  try {
    ...
    error.value = 'Failed to log in: ' + (e?.message || 'Unknown error');
  }
};
</script>
