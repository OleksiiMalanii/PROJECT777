<template>
  <section class="pt-28 pb-32 pl-20 pr-6 md:pl-32 md:pr-12 text-white font-sci-fi">
    ...
    <div
      class="fixed bottom-0 left-0 right-0 bg-gray-900 bg-opacity-90 backdrop-blur-sm p-4 mb-12  border-t border-gray-700">
...
export default {
  setup() {
    ...
    const showAlert = (message, type = 'error') => {
      ...
      alert.className = `fixed top-5 left-1/2 transform -translate-x-1/2 px-6 py-3 rounded-md shadow-lg z-50 ${type === 'error' ? 'bg-red-600' : 'bg-green-600'
